...
SECRET_KEY = config(
    'DJANGO_SECRET_KEY',
    default='django-insecure-local-dev-key-replace-in-production'
)
...
ASGI_APPLICATION = 'movie_backend.asgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'RESTful API for movie recommendations with ML-based personalization',
    'VERSION': '1.0.0',
...
# ML Model Configuration (for later)
